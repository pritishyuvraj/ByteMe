...
$inserting_friend="INSERT INTO $adding1(usn,unique_no,foreign_usn,comment,type,time) VALUES('$userid','$fr_comment',2,'$what_comment','$usn_meant','$time')";
if(!mysqli_query($con_central,$inserting_friend)){
echo"could not write comments".mysqli_error($con_central);
}
if(strcasecmp($userid,$usn_meant)){
if(!mysqli_query($con_central,$inserting_friend)){
echo"could not sucessfully connect ".mysqli_error($con_central);
}
}
$friends1=$usn_meant."my_friends";
$my_friends=mysqli_query($con_meanigful,"SELECT usn FROM $friends1 WHERE usn!='$userid' OR usn!='$usn_meant'");
$zmr=0;
$friends_usn=array();
...
$write_friends_wall="INSERT INTO $friends2(usn,unique_no,foreign_usn,comment,type,time)
				VALUES('$userid','$fr_comment',2,'$what_comment','$usn_meant','$time')";
